...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=0e3ce324a9a86dd02615)
 * Config saved to config.json and https://gist.github.com/0e3ce324a9a86dd02615
 */
...
$(document).ready(function() {
    ...
    $(window).resize(function() {
        ...
        if ($(window).width() < 767) $('.js-select').removeClass('is-active');
    });
    ...
    function fixHead() {
        ...
        $('.js-open-mc').on('click', function(e) {
            ...
            if ($(document).scrollTop() < navTop) {
                $('.js-match-center').slideToggle(100);
        ...
        $('.js-menu-link').on('click', function(e) {
            ...
            if ($(this).hasClass('is-active')) {
                ...
                items.slideUp();
                fixedHeight = 1;
            } else if (items.hasClass('is-active')) {
                // during
                items.removeClass('is-active');
                items.hide();
                currItem.show();
    ...
    $('.js-accordion').each(function() {
        ...
        $('.js-accordion-title').click(function() {
            if ($(this).parents('.js-accordion').hasClass('is-active')) {} else {
    ...
    function adaptiveSliders() {
        ...
        if ($(window).width() < 768) {
            ...
            if (!$('.js-player-info-slider').hasClass('slick-initialized')) {
            ...
            if ($('.js-player-info-slider').hasClass('slick-initialized')) {
                $('.js-player-info-slider').slick('unslick');
            };
        };
        ...
        if ($(window).width() <= 991) {
            ...
            if ($('.js-org-slider').hasClass('slick-initialized')) {
                $('.js-org-slider').slick('unslick');
            }
